...
#./halite -s 2278402832 -d "30 30" "java MyBot" "java -cp ~/projects/halitebot/v30 MyBot"
#./halite -s 2278402832 -d "30 30" "java -cp ~/projects/halitebot/v30 MyBot" "java MyBot"
...
#./halite -s 1137230759 -d "30 30"  "java -cp ~/projects/halitebot/v30 MyBot" "java MyBot"

# small and close
#./halite -t -s 3590102676 -d "30 30" "java -cp ~/projects/halitebot/v30 MyBot" "java -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5005,quiet=y MyBot"
#./halite -s 3590102676 -d "30 30" "java MyBot" "java -cp ~/projects/halitebot/v30 MyBot"
#./halite -s 3590102676 -d "30 30" "java -cp ~/projects/halitebot/v30 MyBot" "java MyBot"
